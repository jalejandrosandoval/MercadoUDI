...
{
    public partial class Remove_Users_Delete : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    id_User = Convert.ToInt32(Session["Id_User_Remove"].ToString());

                    if (!IsPostBack)
                    {
                        if (Session["Id_User_Remove"] != null)
                        {
            ...
            try
            {
                ...
                if (IsValid)
                {
                    ...
                    if (Session["Username"].ToString() != txt_Username.Text)
                    {
                        ...
                        string script = @"alert('This User has been deleted!');
                            window.location.href='Remove_Users.aspx';";
