<%@ Page Title="" Language="C#" MasterPageFile="~/PageMasterClient.Master" AutoEventWireup="true" CodeBehind="ShoppingCartClient.aspx.cs" Inherits="Parcial02_MercadoUDi.ShoppingCartClient" %>
        ...
        <div class="col-md-8 col-md-offset-3">
            ...
            <div>
                ...
                <asp:GridView ID="GridView_Shopping" runat="server"
                    ...
                    BorderWidth="1px">
                    <Columns>
                        <asp:CommandField EditText="Edit" SelectText="Select" ShowEditButton="True" />
