<%@ Page Title="" Language="C#" MasterPageFile="~/PageMasterDefault.Master" AutoEventWireup="true" CodeBehind="Default_Products_Details.aspx.cs" Inherits="Parcial02_MercadoUDi.Default_Products_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <form role="form" id="form1" runat="server">
        ...
        <div class="col-md-11 col-md-offset-1">
            ...
            <asp:ListView ID="ListView_Products_Details" runat="server" DataKeyNames="IdProduct" DataSourceID="ObjectDataSource_Categories" OnItemDataBound="ListView_Products_Details_ItemDataBound">
                ...
                <ItemTemplate>
                    ...
                    <div class="col-md-12">
                        ...
                        <div runat="server" class="col-md-7">
                            ...
                            <div>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_QuantityList" runat="server" class="form-control" PlaceHolder="Product Quantity" Width="300px"></asp:TextBox> 
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <asp:Button ID="Btn_Add_Shopping_Product_List" runat="server" class="btn btn-block btn-success" Text="Add to cart" Width="380px" />
            ...
            <asp:ObjectDataSource ID="ObjectDataSource_Categories" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBy_IdProduct" TypeName="Parcial02_MercadoUDi.MercadoUDi_DataSetTableAdapters.ProductTableAdapter">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <h4><i class="fa fa-spinner fa-fw"></i> Adding Product to Shopping Cart...</h4>
