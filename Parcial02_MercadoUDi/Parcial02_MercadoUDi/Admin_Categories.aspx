<%@ Page Title="" Language="C#" MasterPageFile="~/PageMasterAdmin.Master" AutoEventWireup="true" CodeBehind="Admin_Categories.aspx.cs" Inherits="Parcial02_MercadoUDi.Admin_Categories" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <div class="col-md-12">
        <table>
            <tr>
                ...
                <td class="col-md-4">
                    <asp:LinkButton ID="AddProduct" runat="server" class="btn btn-md btn btn-info"
                        OnClick="Btn_RegisterCategories_Click">
   ...
   <div class="col-md-12">
         <h5><span> <i class="fa fa-info-circle fa-fw" style="color:#337AB7"></i> For update any category you must select it...</span></h5>
        <br />
    </div> 
                ...
                <ItemTemplate>
                    ...
                    <div runat="server" style="padding: 20px" class="col-md-3">
                        ...
                        <asp:ImageButton runat="server" ImageUrl='<%# Eval("CategoryImage") %>' Height="150" 
                            PostBackUrl='<%# "Update_Category.aspx?IdCat=" + Eval("IdCategory") %>' />
