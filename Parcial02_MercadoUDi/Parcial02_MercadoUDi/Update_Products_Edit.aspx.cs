...
{
    public partial class Update_Products_Edit : System.Web.UI.Page
    {
        ...
        {
            //Response.Redirect("Products_Details_Update.aspx?IdPro=" + Request.Params["IdPro"].ToString());
        }
            ...
            try
            {
                    ...
                    txt_ProductStock.Text != ""  &&  DropDownList_CategoriesProducts.SelectedValue != "")
                {
                    ...
                    tap.Update(ProductName, productImageUpdate, ProductDescription, ProductCategory, 
                        ProductStock, ProductPrice, ProductCreatedBy_Id, System.DateTime.Now, IdPro);

                    string script = @"alert('Information of this Product Updated');
                            window.location.href=Update_Products.aspx';";
