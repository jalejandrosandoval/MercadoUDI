<%@ Page Title="" Language="C#" MasterPageFile="~/PageMasterAdmin.Master" AutoEventWireup="true" CodeBehind="Register_Category.aspx.cs" Inherits="Parcial02_MercadoUDi.Register_Category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <div class="col-lg-12">
        <h2 class="page-header">Register Category</h2>
    </div>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h2 class="panel-title"><i class="fa fa-user-plus"></i> Add New Category...</h2>
                </div>
