<%@ Page Title="" Language="C#" MasterPageFile="~/PageMasterAdmin.Master" AutoEventWireup="true" CodeBehind="Register_User.aspx.cs" Inherits="Parcial02_MercadoUDi.Register_User" %>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h2 class="panel-title"><i class="fa fa-user-plus fa-fw"></i> Add a New User...</h2>
                </div>
                    ...
                    <form role="form" id="form_Update" runat="server">
                        <fieldset>
                            ...
                            <div>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox class="form-control" ID="txt_Username" runat="server" PlaceHolder="Username" Width="320px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox class="form-control" ID="txt_Email" runat="server" PlaceHolder="Email" Width="320px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox class="form-control" ID="txt_Password" runat="server" PlaceHolder="Password" type="Password" Width="320px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox class="form-control" ID="txt_ConfirmPassword" runat="server" PlaceHolder="Confirm Password" type="Password" Width="320px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox class="form-control" ID="txt_UserCard" runat="server" PlaceHolder="Number Card" Width="320px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <asp:Button ID="Btn_Save" runat="server" Text="Save" class="btn btn-block btn btn-info" OnClick="Btn_Save_Click" />
                                </div>
                                <div class="col-md-6">
