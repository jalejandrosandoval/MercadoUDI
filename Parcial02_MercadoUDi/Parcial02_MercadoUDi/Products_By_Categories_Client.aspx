<%@ Page Title="" Language="C#" MasterPageFile="~/PageMasterClient.Master" AutoEventWireup="true" CodeBehind="Products_By_Categories_Client.aspx.cs" Inherits="Parcial02_MercadoUDi.Products_By_Categories_Client" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <form role="form" id="form1" runat="server">
        ...
        <div>
            <a href="List_Categories_Client.aspx" class="btn btn-md btn btn-link"><i class="fa fa-arrow-left fa-fw"></i>Back</a>
        </div>
                ...
                <ItemTemplate>
                    ...
                    <div runat="server" style="padding: 20px" class="col-md-4">
                        ...
                        <asp:ImageButton runat="server" ImageUrl='<%# Eval("ProductImage") %>' Height="200" 
                            PostBackUrl='<%# "Products_Details_Client.aspx?IdPro=" + Eval("IdProduct") %>' />
