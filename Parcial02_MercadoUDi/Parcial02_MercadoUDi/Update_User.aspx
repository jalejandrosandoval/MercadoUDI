<%@ Page Title="" Language="C#" MasterPageFile="~/PageMasterAdmin.Master" AutoEventWireup="true" CodeBehind="Update_User.aspx.cs" Inherits="Parcial02_MercadoUDi.Update_User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
     ...
     <div class="col-lg-12">
        <h2 class="page-header">Updates Users...</h2>
    </div>
